...
export function RecordingsTable(props: { data: Sample[] }) {
    return (props.data.length === 0 ? <Typography>No recordings</Typography> : <TableContainer>
